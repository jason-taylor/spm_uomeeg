function [scd,montage] = ft_scalpcurrentdensity_jt(cfg, data)
...
%
% Use as
%   [data,montage] = ft_scalpcurrentdensity(cfg, data) % jt: output montage
% or
...
% jt hacked to output montage (29/Apr/2022)
