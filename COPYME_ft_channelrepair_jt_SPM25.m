function [data,repair] = ft_channelrepair_jt(cfg, data)
...
%
% Use as
%   [interp,repair] = ft_channelrepair(cfg, data) % jt output repair
...
%
% jt hacked to output 'repair' montage - SPM25 version (19/June/2025)
